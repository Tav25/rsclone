...
class world1scene2 extends Phaser.Scene {
  ...
  create() {
    ...
    const rectangleBottom = new RectanglePhysics(this, 0, 575, map.widthInPixels, 3, () => { this.gameSet.hero.y = 20; this.gameSet.hero.x = this.player1.x; this.scene.start('world1scene1'); this.scene.stop('world1scene2'); });
    const rectangleLeft = new RectanglePhysics(this, -2, 0, 3, map.heightInPixels, () => { this.gameSet.hero.x = 545; this.gameSet.hero.y = this.player1.y; });
