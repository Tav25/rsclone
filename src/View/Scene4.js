...
class Scene4 extends Phaser.Scene {
  ...
  create() {
    ...
    this.physics.add.overlap(this.player1, this.rectangleBottom, () => { data.hero.y = 20; data.hero.x = this.player1.x; });
    this.physics.add.overlap(this.player1, this.rectangleLeft, () => { data.hero.x = 545; data.hero.y = this.player1.y; this.scene.stop('Scene4'); this.scene.start('Scene2'); });
