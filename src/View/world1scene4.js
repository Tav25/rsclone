...
class world1scene4 extends Phaser.Scene {
  ...
  create() {
    ...
    const rectangleTop = new RectanglePhysics(this, 0, -2, map.widthInPixels, 3, () => { this.gameSet.hero.y = 545, this.scene.stop('world1scene4'); this.scene.start('world1scene1'); });
