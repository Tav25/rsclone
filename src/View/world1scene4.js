...
class world1scene4 extends Phaser.Scene {
  ...
  create() {
    ...
    const rectangleTop = new RectanglePhysics(this, 0, -2, this.map.widthInPixels, 3, () => { this.model.world.mainCharacter.setPosition(this.scene.scene.key, [this.player1.x, 545]); this.scene.stop('world1scene4'); this.scene.start('world1scene1'); });
